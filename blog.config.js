...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xwg', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '无', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xwg.today', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'xwg', // 网站关键词 英文逗号隔开
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '1', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
  ADSENSE_GOOGLE_SLOT_FLOW:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '1', // Google AdScene>广告>按单元广告>新建信息流广告
  ADSENSE_GOOGLE_SLOT_NATIVE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_NATIVE || '1', // Google AdScene>广告>按单元广告>新建原生广告
  ADSENSE_GOOGLE_SLOT_AUTO:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '1', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
  ...
  // RSS订阅
  ENABLE_RSS: false, // process.env.NEXT_PUBLIC_ENABLE_RSS || false, // 是否开启RSS订阅功能
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '小乌龟', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '无', // 站点描述，被notion中的页面描述覆盖
